				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="row">
							<div class="col-md-10"><div class="form-group">
								...
								<div class="col-md-6">
									<select name="sltCate" id="inputLoai" class="form-control">
						      			...
						      			<?php MenuMulti($cat,0,$str='Sản phẩm:',$loai); ?>   		
						      		</select>
									<script>
								...
								<div class="col-md-3">
									<input type="search" name="txttk" id="inputTxttk" class="form-control" value="" placeholder="Tìm sản phẩm...">
								</div>
							</div>
							...
							<div class="col-md-2">
								@if ($loai !='all')
									<a href="{!!url('admin/sanpham/'.$loai.'/add')!!}" title=""><button type="button" class="btn btn-primary pull-right">Thêm sản phẩm mới</button></a>
								@endif
							</div>
						</div> 
