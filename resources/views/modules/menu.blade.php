 <!-- main menu  navbar -->
    <nav class="navbar navbar-default navbar-top" role="navigation" id="main-Nav" style="background-color: #000000;margin-bottom: 5px;font-size: 16px;">
      <div class="container">  
        <div class="row">
          ...
          <div class="collapse navbar-collapse" id="main-mav-top">
            <ul class="nav navbar-nav">
              ...
              <li>
                <a href="{!!url('mobile')!!}" ><i class="glyphicon glyphicon-phone" style="font-size:16px"></i> Điện Thoại </a>                          
              </li>                                                  
              <li >
                <a href="{!!url('laptop')!!}" ><i class="fa fa-laptop" style="font-size:19px"></i> Laptop </a>                
              </li>    
              <li>
                <a href="{!!url('pc')!!}" ><i class="fa fa-television" style="font-size:15px"></i> Máy Tính Bộ </a>               
  ...
  <div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
      ...
      <div class="loginmodal-container">
        ...
        <div class="login-help">
          <a class="btn btn-link" href="{!!url('/register')!!}"> <strong style="color:red;"> Đăng ký </strong> </a>
        </div>
      </div>
    </div>
  </div>